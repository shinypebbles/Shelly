...
This project collects data from the Shelly Plus Plug S and stores it in an Oracle database (v12.1). The data is displayed in a graph using Oracle APEX (v22.2).
